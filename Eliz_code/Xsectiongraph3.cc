...
void Xsectiongraph3() {
  ...
  //define final state cross sections for pos and neg mu:
    ...
    graph_draw(Whp,"Wh+MET+mu","mu GEV","XSection","Wh+mu.png");
    graph_draw(WWp,"WW+MET+mu","mu GEV","XSection","WW+mu.png");
    graph_draw(ZZp,"ZZ+MET+mu","mu GEV","XSection","ZZ+mu.png");
    graph_draw(hZp,"hZ+MET+mu","mu GEV","XSection","hZ+mu.png");
    graph_draw(hhp,"hh+MET+mu","mu GEV","XSection","hh+mu.png");
    graph_draw(WZn,"WZ-MET+mu","mu GEV","XSection","WZ-mu.png");
    graph_draw(Whn,"Wh-MET+mu","mu GEV","XSection","Wh-mu.png");
    graph_draw(WWn,"WW-MET+mu","mu GEV","XSection","WW-mu.png");
    graph_draw(ZZn,"ZZ-MET+mu","mu GEV","XSection","ZZ-mu.png");
    graph_draw(hZn,"hZ-MET+mu","mu GEV","XSection","hZ-mu.png");
    graph_draw(hhn,"hh-MET+mu","mu GEV","XSection","hh-mu.png");
