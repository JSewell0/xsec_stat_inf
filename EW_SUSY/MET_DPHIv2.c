...
void CutFlow(WHBB& obj, TTree *&tree, double weight, int pdgid, TH1F *&hist, TH1F *&hist2, TH1F *&hist3){
 
  Long64_t nentries = tree->GetEntriesFast();

  for(Long64_t jentry=0;jentry<nentries;jentry++){
    
    cout<<"loop start num: "<<jentry<<endl;
    cout<<"Address of obj: "<<&obj<<endl;
    obj.GetEntry(jentry);//cout<<fChain<<endl;
    
    MET4.SetPtEtaPhiE(obj.MET,0,obj.METPhi,0);
    cout<<"obj.MET: "<<obj.MET<<endl;
...
//CutFlow(WHBB obj, TTree* tree, double weight, int pdgid, TH1F* hist, TH1F* hist2, TH1F* hist3)
